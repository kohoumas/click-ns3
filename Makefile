...
EXTRA_PROVIDES =
PROVISIONS = x86_64 analysis int64 linux pcap wifi $(EXTRA_PROVIDES)
...
INSTALL_TARGETS =  install-userlevel install-ns install-tools
CLEAN_TARGETS =  clean-userlevel clean-ns clean-tools
...
config.status: $(srcdir)/configure
	$(SHELL) $(srcdir)/configure  '--enable-nsclick' '--disable-linuxmodule' '--enable-wifi'
